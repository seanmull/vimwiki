...
-   [x] Log into tpg to figure out if the cancellation stuck
-   [x] RSVP for the Christmas party Dec 9th 5-10 pm western theme.
-   [x] Bitlocker issues with windows
-   [x] Call up Kia to test drive sportage and sorento

-   [x] Send request for time off
-   [x] Call up Allison
-   [x] Reshedule Smartride for a day thats not Tuesday next week.
-   [x] Talk to matt about the Tesla
-   [x] Give [Allison an update.](Allison an update.)
-   [x] Respond to Lauren regarding the coorespondence.
